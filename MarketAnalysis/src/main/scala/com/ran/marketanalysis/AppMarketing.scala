package com.ran.marketanalysis
...
case class CountAgg() extends AggregateFunction[(String,Long),Long,Long]{
...
case class MarketingCountTotal() extends WindowFunction[Long,MarketingViewCount,String,TimeWindow]{
